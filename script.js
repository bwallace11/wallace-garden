    ...
    items: [
      {
        ...
        content: '<article class="content-block"><h2>Typography Ideas</h2><p>Testing dramatic serif headings with compact sans body text gives a moody editorial rhythm that still reads cleanly on dark backgrounds.</p><ul class="entry-list"><li>Display serif for headlines only.</li><li>Inter for body + UI labels.</li><li>Tight heading line-height, looser paragraph spacing.</li></ul></article>'
      },
      {
        title: 'Color Palette Tests',
        summary: 'Purple tonal experiments for atmospheric contrast.',
        content: '<article class="content-block"><h2>Color Palette Tests</h2><p>Deep violet and dark plum work best as anchor tones while lavender should stay reserved for highlights and focus states.</p><ul class="entry-list"><li>Near-black base: #08060f.</li><li>Accent glow: lavender with low opacity.</li><li>Never flood large surfaces with neon.</li></ul></article>'
      },
      {
        title: 'Layout Studies',
        summary: 'Asymmetric card systems with calm visual balance.',
        content: '<article class="content-block"><h2>Layout Studies</h2><p>Asymmetry feels intentional when gutters are consistent and type hierarchy remains predictable across every panel.</p><p>Best results so far come from pairing one dominant panel with two compact support cards.</p></article>'
      }
    ]
  },
  projects: {
    ...
    items: [
      {
        ...
        content: '<article class="content-block"><h2>Java Noir Scrollytelling Project</h2><p>A cinematic narrative page blending coffee history with atmospheric transitions and section-based storytelling beats.</p><h3>Tools Used</h3><p>HTML, CSS, JavaScript, GSAP, ScrollTrigger</p><h3>Design Decisions</h3><p>Used dark framing, staggered reveal timings, and high-contrast type to keep narrative pacing deliberate.</p></article>'
      },
      {
        title: 'History of Web Design Site',
        summary: 'Interactive timeline of web aesthetics by era.',
        content: '<article class="content-block"><h2>History of Web Design Site</h2><p>An educational timeline that tracks major visual and UX shifts from table layouts to immersive interface systems.</p><h3>Tools Used</h3><p>Semantic HTML, CSS Grid/Flex, custom timeline interactions</p><h3>Design Decisions</h3><p>Era-specific accent colors and restrained motion for readability first.</p></article>'
      },
      {
        title: 'Yo-Pida Project',
        summary: 'Character-forward concept site with expressive motion.',
        content: '<article class="content-block"><h2>Yo-Pida Project</h2><p>A playful concept site built around personality-rich visuals, icon sets, and lightweight animation choreography.</p><h3>Tools Used</h3><p>Figma, Illustrator, CSS animations</p><h3>Design Decisions</h3><p>Kept interactions short and snappy so expressive visuals do not overwhelm navigation.</p></article>'
      }
    ]
  },
  experiments: {
    ...
    items: [
      {
        ...
        content: '<article class="content-block"><h2>GSAP Scroll Echo</h2><p>Experiment focuses on subtle header trails that follow scroll-triggered entry animations to create atmospheric depth.</p></article>'
      },
      {
        title: 'Micro Animation Tests',
        summary: 'Button and panel state transitions with subtle depth.',
        content: '<article class="content-block"><h2>Micro Animation Tests</h2><p>Testing hover and active states with tiny scale shifts, glow intensity changes, and short ease-out timing curves.</p></article>'
      },
      {
        title: 'Layout Prototype Lab',
        summary: 'Floating card and split hero explorations.',
        content: '<article class="content-block"><h2>Layout Prototype Lab</h2><p>Prototype set exploring split hero layouts with floating note cards and modular spacing presets for rapid concept iteration.</p></article>'
      }
    ]
  },
  learning: {
    ...
    items: [
      {
        ...
        content: '<article class="content-block"><h2>Week 11 — Motion as Story</h2><p><strong>What I learned:</strong> Motion works best when each animation has a storytelling reason.</p><p><strong>What was difficult:</strong> Maintaining smooth performance with layered visual effects.</p><p><strong>What I experimented with:</strong> Timing offsets and viewport-sensitive trigger thresholds.</p></article>'
      },
      {
        title: 'Week 12 — Systems Thinking',
        summary: 'Token-driven design decisions across multiple pages.',
        content: '<article class="content-block"><h2>Week 12 — Systems Thinking</h2><p><strong>What I learned:</strong> Reusable tokens improve consistency and speed.</p><p><strong>What was difficult:</strong> Naming conventions that scale with project complexity.</p><p><strong>What I experimented with:</strong> Purple tonal ramps tuned for accessible contrast.</p></article>'
      },
      {
        title: 'Week 13 — UX Clarity',
        summary: 'Keeping playful visuals usable and clear.',
        content: '<article class="content-block"><h2>Week 13 — UX Clarity</h2><p><strong>What I learned:</strong> Dense visuals still need obvious navigation affordances.</p><p><strong>What was difficult:</strong> Avoiding clutter while keeping personality.</p><p><strong>What I experimented with:</strong> Progressive disclosure inside desktop-style windows.</p></article>'
      }
    ]
  },
  inspiration: {
    ...
    items: [
      {
        title: 'Web + Visual Influence Board',
        summary: 'Reference sets from websites, music, game UI, and culture.',
        content: '<article class="content-block"><h2>Web + Visual Influence Board</h2><div class="inspiration-grid"><section><h3>Websites</h3><p>Immersive portfolios, web storytelling projects, and nostalgic personal pages.</p></section><section><h3>Music Aesthetics</h3><p>Ambient night-drive sets, dark lo-fi, and synth textures.</p></section><section><h3>Game UI</h3><p>RPG menu systems, diegetic HUD ideas, and inventory interactions.</p></section><section><h3>Dark/Gothic Design</h3><p>Victorian typography, moody textures, and shadow-based layering.</p></section><section><h3>Internet Culture</h3><p>Forum-era weird web energy and handcrafted digital spaces.</p></section></div></article>'
      },
      {
        title: 'Moodboard Notes',
        summary: 'Visual notes for midnight workspace energy.',
        content: '<article class="content-block"><h2>Moodboard Notes</h2><p>Core mood: quiet, glowing, and a little mysterious. Nothing loud or corporate, always intimate and handcrafted.</p><ul class="entry-list"><li>Screen-light contrast over flat backgrounds.</li><li>Nostalgic but modern interface framing.</li><li>Soft glows instead of hard neon blocks.</li></ul></article>'
      }
    ]
  },
  snippets: {
    ...
    items: [
      {
        ...
        content: '<article class="content-block"><h2>Dark Mode Toggle</h2><pre><code>document.body.classList.toggle(\'dark-mode\');</code></pre></article>'
      },
      {
        title: 'CSS Grid Template',
        summary: '12-column layout starter block.',
        content: '<article class="content-block"><h2>CSS Grid Template</h2><pre><code>.layout {\n  display: grid;\n  grid-template-columns: repeat(12, 1fr);\n  gap: 1rem;\n}</code></pre></article>'
      },
      {
        title: 'GSAP Starter Pattern',
        summary: 'Simple staggered reveal animation.',
        content: '<article class="content-block"><h2>GSAP Starter Pattern</h2><pre><code>gsap.from(\'.card\', {\n  y: 24,\n  opacity: 0,\n  duration: 0.8,\n  stagger: 0.1\n});</code></pre></article>'
      }
    ]
  },
  now: {
    ...
    items: [
      {
        ...
        content: '<article class="content-block"><h2>Current Focus</h2><ul class="entry-list"><li>Working through my graphic design degree.</li><li>Building interactive portfolio projects weekly.</li><li>Learning GSAP deeply with late-night build sessions.</li><li>Collecting inspiration from games and atmospheric web work.</li></ul></article>'
      },
      {
        title: 'Life Lately',
        summary: 'Coffee-fueled creation and nightly coding rhythm.',
        content: '<article class="content-block"><h2>Life Lately</h2><p>Most nights are split between coursework, idea sketching, and prototyping interfaces that feel personal, cinematic, and alive.</p></article>'
      }
    ]
  }
};
  ...
  windowData.content.innerHTML = `
    <section class="page-view">
      <header class="page-view-header">
        <h2>${item.title}</h2>
        <button class="page-close" type="button" aria-label="Close page and return to folder">✕</button>
      </header>
  ...
  windowElement.innerHTML = `
    <header class="window-header">
      ...
      <div class="window-actions">
        <button class="window-btn" type="button" data-action="close" aria-label="Close folder">✕</button>
      </div>
    </header>
